  ...
  return (
    <div className="Testimonial" id='features'>
      ...
      <div className='testimonial-phone-view'>
        ...
        <div className="btn-1">
        <a href="https://play.google.com/store/apps/details?id=com.practice.ninja_study&utm_source=Website" target="_blanck"> <button className='submitbtn-1'>Download App Now</button></a>
          </div>
      </div>
